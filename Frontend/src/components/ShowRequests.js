...
const ShowRequests = () => {
    ...
    const openBodyTemplate = (rowData) => {
        function editButtonClicked (){
            ...
            history.push({pathname:'/edit-request', search: id });
        }
        ...
        <Dialog header="Request is deleted!" visible={displayConfirmation2} onHide={() => {setDisplayConfirmation2(false)}} style={{ width: '350px' }} modal footer={confirmationDialogFooter2}>
