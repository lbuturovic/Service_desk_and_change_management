...
const ClosedChanges = props => {
    ...
    const getChanges = () => {
        return axios.get("http://localhost:8080/api/closed-changes", {
            headers: {
                'Authorization': authHeader().Authorization
            }
        }).then((response) => {
        ...
        return (
            <div className="orders-subtable">
                ...
                <DataTable value={data.history} responsiveLayout="scroll">
                    ...
                    <Column field="employee.firstName" header="Executer"></Column>
                    <Column field="employee.lastName" ></Column>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable value={changes} expandedRows={expandedRows} onRowToggle={(e) => setExpandedRows(e.data)} responsiveLayout="scroll"
                        ...
                        <Column field="updated" header="Time closed" sortable body={dateBodyTemplateUpdated} />
                    </DataTable>
                </div>
            </div>
        </div>
...
export default React.memo(ClosedChanges, comparisonFn);
