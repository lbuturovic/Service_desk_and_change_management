...
const ShowRequests = () => {
    ...
    const getAllRequests = (id) => {
        return axios.get("http://localhost:8080/api/request/client/"+id, {
          headers: {
    ...
    const openBodyTemplate = (rowData) => {
        ...
        return <div><Button label="Replay" className="p-button-raised p-button-info mr-2 mb-2" onClick={editButtonClicked}/>
        </div>;
    }
